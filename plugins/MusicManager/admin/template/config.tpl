...
<a href="admin.php?page=plugin-{$plugin_id}&tab=config&r={$cat}"
      ...
      {foreach from=$music_list item=music}
        <li class="music-card">
          ...
          <audio controls preload="none" style="width: 100%; margin-top: 5px;">
            <source src="/photos/plugins/MusicManager/uploads/{$music.category|escape}/{$music.filename|escape}" type="audio/mpeg">
